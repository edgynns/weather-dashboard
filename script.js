// API configuration
const API_KEY = '28a2773556576a4e8c0cf77c1fe1e73f'; // Your OpenWeatherMap API key
const BASE_URL = 'https://api.openweathermap.org/data/2.5';

// DOM Elements - Wait for document to be fully loaded
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function getWeatherData(city) {
        ...
        try {
            // Get current weather
            console.log('Fetching from:', `${BASE_URL}/weather?q=${city}&units=${currentUnit}&appid=${API_KEY}`);
